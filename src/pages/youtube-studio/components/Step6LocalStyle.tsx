...
// ─── Constants ────────────────────────────────────────────────────────────────
const INITIAL_SUBTITLE_SEGMENTS: SubtitleSegment[] = [
...
function buildSubtitleSegmentsFromCuts(cuts: Step5CutData[]): SubtitleSegment[] {
...
const FONT_OPTIONS = ['Pretendard', 'Noto Sans KR', 'Nanum Gothic', 'Black Han Sans', 'Nanum Myeongjo'];
...
function SubtitlePreviewBadge({ tpl, small = false }: { tpl: typeof SUBTITLE_TEMPLATES[0]; small?: boolean }) {
  const p = tpl.preview;
